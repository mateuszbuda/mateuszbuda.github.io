...
Together with the dataset, we shared a GPU enabled Python script kernel that can be run on Kaggle: <a href="https://www.kaggle.com/mateuszbuda/brain-segmentation-pytorch" target="_blank">kaggle.com/mateuszbuda/brain-segmentation-pytorch</a>.
